...
public class SearchListAdapter extends ArrayAdapter {
    ...
    public SearchListAdapter(Context context, int resource, int textViewResourceId, int imageviewResourceID, List objects) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        ImageView icon = (ImageView) inflateview.findViewById(imageviewResourceID);

        tv.setText(searchListItems.get(i).getTitle());

        if (searchListItems.get(i).getIcon() == null){
            icon.setVisibility(View.GONE);
        }else{
            icon.setVisibility(View.VISIBLE);
            try {
                icon.setImageDrawable(searchListItems.get(i).getIcon());
            }catch(Exception e){
                icon.setVisibility(View.GONE);
            }
        }
